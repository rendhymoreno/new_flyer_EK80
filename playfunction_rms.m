...
load(fullfile(globalindPath, 'global_index.mat'));
% flyer = load(flyer);
...
if(sum((strcmp({global_indexer.channel}, channel_38))) > 0)
    ...
    disp('[EK80 Parameter] Generated 38 kHz Data')
end
end
...
if(sum((strcmp({global_indexer.channel}, channel_70))) > 0)
    ...
    disp('[EK80 Parameter] Generated 70 kHz Data')
end
end
...
if( ~strcmp(param, 'power_pc4') && sum((strcmp({global_indexer.channel}, channel_200))) > 0)
    ...
    disp('[EK80 Parameter] Generated 200 kHz Data')
end
end
