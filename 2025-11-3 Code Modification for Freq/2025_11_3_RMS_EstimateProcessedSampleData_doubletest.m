...
Y_pc = zeros(length(SampleData.complexsamples(:,1)),nSectors);
...
[f,~,svf]= EstimateSvf(ChannelData, ParameterData,wbtImpedanceRx,EnvironmentData, transmitSignal, Y_pc,rangeVector);
