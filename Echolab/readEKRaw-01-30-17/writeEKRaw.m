    ...
    switch true
        case (chan < 1000)
            ...
            if ~isempty(chanIdx)
                ...
                writerState(4,i) = length(data.pings(chan).number);
    ...
    switch true
        ...
        case (chan < 1000)
            ...
            if writerState(11,chanIdx)
                ...
                sampledata.heading = data.pings(chan).heading(writerState(3,chanIdx));
                sampledata.transmitmode = data.pings(chan).transmitmode(writerState(3,chanIdx));
            end
            ...
            writeEKRaw_WriteSampledata(fid, sampledata, writerState(11,chanIdx));
