...
%                            Default: false
%
%       tvgCorrection:   Set this parameter to the same value used when converting
%                        your data from power to Sv/sv. By default this true when 
%                        converting to Sv/sv and when converting back to power. If
%                        you applied a custom TVG correction factor you must use the
%                        same value here. IT IS ADVISED NOT TO CHANGE THIS UNLESS
