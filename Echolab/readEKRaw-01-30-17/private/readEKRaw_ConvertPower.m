...
for n=1:nXcvrs
    ...
    %  determine number of samples in array (recast samplerange to
    %  ensure pSize is not forced to uint16)
    pSize = [double(data.pings(n).samplerange(2)) length(data.pings(n).time)];
