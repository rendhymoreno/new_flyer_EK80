function writeEKRaw_WriteSampledata(fid, sampledata, writeTrawl)
...
if (writeTrawl)
    ...
    fwrite(fid, sampledata.heading, 'float32', 'l');
    fwrite(fid, sampledata.transmitmode, 'int16', 'l');
    fwrite(fid, [0 0 0 0 0 0], 'uchar', 'l');
end
