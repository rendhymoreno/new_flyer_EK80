...
%                       applications you can explicitly specify the tvgCorrection
%                       by setting this keyword to a number specifying the TVG
%                       correction offset in samples. IT IS ADVISED NOT TO CHANGE
