...
samplingFrequency   = 1/ParameterData.SampleInterval;
f                   = linspace(ParameterData.FrequencyStart,ParameterData.FrequencyEnd,nFrequencyPoints)';
...
sampleRange         = ParameterData.SampleInterval*soundSpeed/2;
