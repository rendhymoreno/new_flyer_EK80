classdef cSampleDataRAW3_AR13
    %  cSampleDataRAW3_AR13
    %      New class for armstrong ek80 v3
    ...
    methods
        ...
        function x = asStruct(obj)
            x = struct(...
                ...
                'count', obj.count, ...
                'power_cw', obj.power, ...
                'alg_ele', obj.alongship, ...
                'ath_ele', obj.athwartship, ...
                ...
                'dR', obj.dR, ...
                'timestampunix', obj.timestampunix );

%                 'highdatetime', obj.highdatetime, ...
%                 'lowdatetime', obj.lowdatetime, ...
%                 'highdatetime_shifted', obj.highdatetime_shifted ...
        ...
        function obj = read(obj,fid)
            ...
            % I think this is CW mode. Check the interface manual!
            % obj.datatype shows which type of data is this (CS/BB)
            if (bitget(obj.datatype, 1, 'int16')) % power values
                ...
                if (bitget(obj.datatype, 2, 'int16')) % angle values
                    obj.angle           = fread(fid,[2 obj.count],'int8', 'l');
...
%                 samples      = fread(fid,2*ncomplex*obj.count,'float32=>single');
                samples      = fread(fid,2*ncomplex*obj.count,'float32');
